/* PrismJS 1.28.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+c+csharp+cpp+cmake+d+dart+diff+django+fortran+gcode+git+glsl+go+go-module+haml+hlsl+http+hpkp+hsts+java+javadoc+javadoclike+jsdoc+js-extras+json+json5+julia+kotlin+lua+makefile+markdown+markup-templating+matlab+maxscript+nginx+nim+opencl+pascal+perl+php+phpdoc+php-extras+python+ruby+rust+sqf+sql+swift+typescript+uri+vim+wasm+wgsl+zig&plugins=line-numbers+highlight-keywords */
var _self =
